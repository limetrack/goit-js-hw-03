function makeArray(firstArray, secondArray, maxLength) {
  ...
  // Перевіряємо, чи перевищує кількість елементів у новому масиві maxLength
  if (newArray.length > maxLength) {
    return newArray.slice(0, maxLength); // Повертаємо копію масиву з довжиною maxLength елементів
  }
